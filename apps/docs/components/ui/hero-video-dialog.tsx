				...
				<AnimatePresence>
					{isVideoOpen && (
						<motion.div
							...
							exit={{ opacity: 0 }}
							className="fixed inset-0 z-[9999] flex items-center justify-center backdrop-blur-sm bg-background/5"
						>
							<motion.div
								{...selectedAnimation}
							...
							>
								<motion.button
									onClick={() => setIsVideoOpen(false)}
									className="absolute -top-16 right-0 text-white text-xl bg-neutral-900/50 ring-1 backdrop-blur-sm rounded-full p-2 dark:bg-neutral-100/50 dark:text-black"
								>
